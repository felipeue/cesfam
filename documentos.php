								...
								<div class="col-md-9 services-left">
									...
									<div class="services-left-grids">
										<div class="col-md-6 services-left-grid container">
										  ...
										  <a class="caption-btn" href="examenesu_web.php">Examenes</a>
										</div>
										<div class="col-md-6 services-left-grid container">
											<a class="caption-btn" href="manualesu_web.php">Manuales</a>
											 

										</div>
										<div class="col-md-6 services-left-grid">
										<a class="caption-btn" href="informativosu_web.php">Informativos</a>
											
										</div>
										<div class="col-md-6 services-left-grid">
											<a class="caption-btn" href="variosu_web.php">Varios</a>
