			...
			<div class="header header-border">
				<div class="container">
					...
					<div class="top-nav">
						...
						<ul>
							<li class="active"><a href="intranet_mobile.php">Inicio</a></li>
								...
								<div class="col-md-9 services-left">
									...
									<div class="services-left-grids">
										<div class="col-md-6 services-left-grid">
											<form action ="valcambioclavefinal_mobile.php" method="post">
												<h3>Ingrese su clave nueva:</h3><br>

										<input type="password" class="text" name="pass" id="pass" required><br>
										<label>Confirme su contraseña nueva</label>
										<input type="password" class="text" name="pass2" id="pass" required><br>
