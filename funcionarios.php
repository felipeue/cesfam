...
//creamos la sesion
session_start();
require_once("validadores.php");//validamos si se ha hecho o no el inicio de sesion correctamente
require_once("connect.php");
//si no se ha hecho la sesion nos regresará a login.php
$aux=funciexist($_SESSION['rut']);
if($aux == TRUE) 
{
  ?>
	...
	<body>
		...
		<div class="contact">
				<div class="container">
					...
					<h1>Portal Funcionarios</h1>
					
						<div class="contact-form contact-form-row2">
							<form action ="intranetval.php" method="post">
								<div>
									<div>
										<span>Rut:</span><br>
