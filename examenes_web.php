				...
				<div class="container">
					...
					<div class="top-nav">
						...
						<ul>
							...
							<li class="active"><a href="borrar.php">Documentos</a></li>
								...
								<div class="col-md-9 services-left">
									...
									<div class="services-left-grids">
										<form action="delete3.php" method="post" enctype="multipart/form-data">
											...
											require_once("connect.php");
											$result = mysql_query("SELECT DISTINCT ano from documento where tipo = 'examenes' order by ano DESC");
										    while ($row = mysql_fetch_row($result))
										    {   
										    	echo "<div class='col-md-6 services-left-grid container'>";
                                                echo "<h2>$row[0]</h2>";
                                                $ano= $row[0];
											    $result2 = mysql_query("SELECT nombre, ano, descripcion, documento, id from documento where tipo = 'examenes' and ano=$ano");
											...
											<a class="caption-btn" href="borrar.php">Volver</a>
									<div class="clearfix"> </div>
								  </div>
								</div>
