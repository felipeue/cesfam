	...
	<body>
				...
				<div class="container">
					...
					<div class="top-nav">
						...
						<ul>
							...
							<li><a href="about_web.html">Nosotros</a></li>
							<li><a href="postas_web.html">Postas</a></li>
					      ...
					      <ul class="rslides" id="slider4">
					        <li>
					          ...
					          <div class="slider-caption">
					         	 ...
					         	 <a class="caption-btn" href="about_web.html">Leer mas</a>
					          </div>
					        </li>
					        <li>
		...
		<div class="bottom-grids">
				...
				while ($row = mysql_fetch_row($result))
				{
					...
					<a href='noticias_web.php''><img src='$ruta' title='name' /></a>
					</div>
					<div class='col-md-9 bottom-grid-right'>
					<h3 style='color : white'>$row[0]</h3>
					<p>$row[3]</p>
					<a class='news-btn' href='noticias_web.php''>Leer mas</a>
					</div>
					<div class='clearfix'> </div>
					</div>
				</div>";
				...
				?>
				<div class="clearfix"> </div>
				<a class="load-news" href="noticias_web.php">Mas noticias</a>
			</div>
		</div>
		...
		<div class="footer">
			<div class="container">
				<p class="copy-right"><a href="">Desarrollado por</a></p>
							<div class="team-grids-caption-right">
                <p class="copy-right"><a href="admin.php">Administrador</a></p>
			</div>
			</div>
		</div>
		<!-- /footer -->
