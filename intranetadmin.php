								...
								<div class="col-md-9 services-left">
									...
									<div class="services-left-grids">
										<div class="col-md-6 services-left-grid">
											...
											<p>Ingrese para nuevo agregar funcionario a CESFAM</p>
											<a class="more-btn" href="funcionario_form.php">Ingresar</a>
										</div>
										<div class="col-md-6 services-left-grid">
											<h3>Borrar Funcionario</h3>
											<p>Borrar funcionario de CESFAM</p>
											<a class="more-btn" href="funcionario_borrar.php">Ingresar</a>
										</div>
											<div class="col-md-6 services-left-grid">
											<h3>Borrar evento</h3>
											<p>Borrar evento de CESFAM</p>
											<a class="more-btn" href="evento_borrar.php">Ingresar</a>
										</div>
										<div class="col-md-6 services-left-grid">
											<h3>Subir estadistica</h3>
											<p>Subir nuevo documento estadistico</p>
											<a class="more-btn" href="subir_estadistica.php">Ingresar</a>
										</div>
										<div class="clearfix"> </div>
										<ul class="pagenation">
								...
								<div class="col-md-3 services-right">
									<h3>Examenes</h3>
										...
										<div class="col-md-3 services-right">
											...
											<a class="more-btn" href="cambiarclaveadm.php">Entrar</a>
