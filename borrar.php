								...
								<div class="col-md-9 services-left">
									...
									<div class="services-left-grids">
										<div class="col-md-6 services-left-grid container">
										  ...
										  <a class="caption-btn" href="examenes_web.php">Examenes</a>
										</div>
										<div class="col-md-6 services-left-grid container">
											<a class="caption-btn" href="manuales_web.php">Manuales</a>
											 

										</div>
										<div class="col-md-6 services-left-grid">
										<a class="caption-btn" href="informativos_web.php">Informativos</a>
											
										</div>
										<div class="col-md-6 services-left-grid">
											<a class="caption-btn" href="varios_web.php">Varios</a>
