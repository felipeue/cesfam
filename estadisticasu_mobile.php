	...
	<body>
				...
				<div class="container">
					...
					<div class="top-nav">
						...
						<ul>
							...
							<li class="active"><a href="estadisticasu_mobile.php">Estadisticas</a></li>
		...
		<div class="services">
                    ...
                    <div class="col-md-6 services-left-grid container">
                      ...
                      <a class="caption-btn" href="correccionesu_mobile.php">Correcciones</a>
                    </div>
                    <div class="col-md-6 services-left-grid container">
                      <a class="caption-btn" href="enviadosu_mobile.php">Enviados</a>
                       

                    </div>
                    <div class="col-md-6 services-left-grid">
                    <a class="caption-btn" href="remcomentadou_mobile.php">REM Comentado</a>
                      
                    </div>
                                        <div class="col-md-6 services-left-grid">
                    <a class="caption-btn" href="remoficialu_mobile.php">REM Oficial</a>
                      
                    </div>
                    <div class="col-md-6 services-left-grid">
                      <a class="caption-btn" href="estvariosu_mobile.php">Varios</a>
