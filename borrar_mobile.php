	...
	<body>
		...
		<div class="services">
                    ...
                    <div class="col-md-6 services-left-grid container">
                      ...
                      <a class="caption-btn" href="examenes_mobile.php">Examenes</a>
                    </div>
                    <div class="col-md-6 services-left-grid container">
                      <a class="caption-btn" href="manuales_mobile.php">Manuales</a>
                       

                    </div>
                    <div class="col-md-6 services-left-grid">
                    <a class="caption-btn" href="informativos_mobile.php">Informativos</a>
                      
                    </div>
                    <div class="col-md-6 services-left-grid">
                      <a class="caption-btn" href="varios_mobile.php">Varios</a>
